...
def test_edge_control():
    ...
    edge_control_model_alt = cw.Model(rules,experiment=experiment_edge_alt,model_name='edge_control_alt')
    ...
    assert(cp.all(edge_control_model_alt.trajectories[-1]==cp.array([[False],[False],[False]])))
